...
В результате выполнения запроса пользователю задается роль для указанной комнаты и в теле ответа возвращается параметр `roomUrl`, содержащий ссылку для доступа вида:  
...
**POST  https://moodhood-api.livedigital.space/v1/spaces/60d55c0eb9ef88ab17b0aabb/analytics/calls?roomId=60d55c0eb9ef88ab17b0aabb&date=2024-01-01**
...
В результате выполнения запроса вы получите спивок звонков в которых участвовал/учавствует пользователь
